...
public class CitatyController {
  ...
  public ModelAndView citat() {
    return new ModelAndView("citat").addObject("citat", service.nahodnyCitat());
  }

  @GetMapping("/{cislo}")
  public ModelAndView konkretniCitat(@PathVariable int cislo) {
    return new ModelAndView("konkretni").addObject("konkretniCitat", service.konkretniCitat(cislo - 1));
  }
}
